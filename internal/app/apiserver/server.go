...
func (s *Server) configureRouter() {
	...
	private.Use(s.authMiddleware())
	{
		...
		private.GET("/ethereum/organization/accounts/:id", s.HandleGetEthereumAccountForOrganization)
		private.PUT("/ethereum/accounts", s.HandleUpdateEthereumAccount)
		private.PUT("/ethereum/accounts/address", s.HandleUpdateEthereumAccountAddress)
		...
		private.GET("/nucypher/organization/accounts/:id", s.HandleGetNucypherAccountForOrganization)
		private.PUT("/nucypher/accounts", s.HandleUpdateNucypherAccount)
		private.PUT("/nucypher/accounts/address", s.HandleUpdateNucypherAccountAddress)
		private.PUT("/nucypher/accounts/verifyingkey", s.HandleUpdateNucypherAccountVerifyingKey)
