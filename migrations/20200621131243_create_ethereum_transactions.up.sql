...
CREATE TABLE ethereum_transactions (
    ...
    sender_account_id int REFERENCES ethereum_accounts (account_id) not null,
    sender_account_address text REFERENCES ethereum_accounts (address) not null,
    recipient_id int REFERENCES organizations (organization_id) not null,
    recipient_account_id int REFERENCES ethereum_accounts (account_id) not null,
